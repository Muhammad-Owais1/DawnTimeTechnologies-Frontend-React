    ...
    <div className="bg-pattern">
      ...
      >
        <div data-aos="fade-right" className="mb-10">
          ...
          <p className="text-sm ">
            At Dawn Time Technologies, we specialize in providing top-tier web
            and app development services by connecting skilled developers with
        ...
        <div className="mb-10" data-aos="fade-left">
          ...
          <p className="text-sm ">
            ...
            challenges in finding job opportunities or freelance tasks. By
            joining our platform, these developers can now showcase their
            talents and work on a variety of projects that match their
            expertise.
          </p>
        </div>
        ...
        <div data-aos="fade-right" className=" mb-10">
          ...
          <ul className="list-disc list-inside">
            ...
            <li className="text-sm mb-2">
              <strong className="font-semibold">App Development:</strong> iOS
              and Android apps, Cross-platform development, User-centric design
            </li>
          </ul>
        </div>
        ...
        <div data-aos="fade-left" className="mb-10">
          ...
          <ul className="list-disc list-inside">
            <li className="text-sm mb-2">
              <strong className="font-semibold">Empowering Developers:</strong>{" "}
              We believe in the potential of every developer. By joining Dawn
              Time Technologies, developers who struggled to find opportunities
              can now work on meaningful projects and build their careers.
            </li>
            <li className="text-sm mb-2">
            ...
            <li className="text-sm mb-2">
              ...
              embracing remote work, we bring together the best talent from
              around the world, ensuring diverse perspectives and innovative
              solutions.
            </li>
            <li className="text-sm mb-2">
              <strong className="font-semibold">
              ...
              We maintain rigorous quality standards, ensuring that every
              project is delivered with excellence and precision.
            </li>
          </ul>
        </div>
        ...
        <div data-aos="fade-right" className="mb-10">
          ...
          <p className="text-sm ">
            ...
            thrive, and clients can access the expertise they need to bring
            their digital visions to life. We are committed to fostering a
            collaborative and supportive environment that drives innovation and
            success.
          </p>
        </div>
        ...
        <div data-aos="fade-left" className="mb-10">
          ...
          <p className="text-sm ">
            Are you a developer looking for new opportunities? Or a client in
            need of expert development services? Dawn Time Technologies is here
            to help. Contact us today to learn more about how we can work
